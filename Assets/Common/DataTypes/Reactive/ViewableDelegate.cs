...
namespace Common.DataTypes.Reactive
{
    public class ViewableDelegate : IViewableDelegate
    {
        ...
        public void Listen(ILifetime lifetime, Action listener)
        {
    ...
    public class ViewableDelegate<T> : IViewableDelegate<T>
    {
        ...
        public void Listen(ILifetime lifetime, Action<T> listener)
        {
            _listeners.Add(listener);
    ...
    public class ViewableDelegate<T1, T2> : IViewableDelegate<T1, T2>
    {
        ...
        public void Listen(ILifetime lifetime, Action<T1, T2> listener)
        {
            _listeners.Add(listener);
    ...
    public class ViewableDelegate<T1, T2, T3> : IViewableDelegate<T1, T2, T3>
    {
        ...
        public void Listen(ILifetime lifetime, Action<T1, T2, T3> listener)
        {
            _listeners.Add(listener);
