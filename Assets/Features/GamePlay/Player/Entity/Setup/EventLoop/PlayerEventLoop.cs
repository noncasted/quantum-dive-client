...
namespace GamePlay.Player.Entity.Setup.EventLoop
{
    public class PlayerEventLoop : IPlayerObjectEventLoop, ICallbackRegister
    {
        private readonly List<IPlayerEntityAttachedListener> _entityAttached = new();
        ...
        {
            TryAddToList(_entityAttached, listener);
        ...
        {
            foreach (var callback in _entityAttached)
